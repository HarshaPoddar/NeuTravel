...
import { BaseUrl, GetUserRole, GetProjectList, GetUserList, CreateRequest, GetTravelListingByInitiatorId, GetListOfCities, CancelTravel } from "app/ClassFiles/service-url";
...
export class NeuTravelService {
 ...
 CancelTravel(travelId:number){
   this.http.post(BaseUrl+ CancelTravel + travelId,null).subscribe((res: Response) => { res.json(); });
 }
